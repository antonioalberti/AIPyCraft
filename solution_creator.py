...
init(autoreset=True)  # This ensures automatic reset of styles after each print
...
class SolutionCreator:
    ...
    def create_new_solution(self):
        solution_name = input(Fore.CYAN + Style.BRIGHT + "\n\nEnter a name for the new solution: ")
        solution_description = input(Fore.CYAN + "Enter a high-level description of the solution: ")
...
"""
        ...
        while True:
            ...
            if approval.lower() == "yes":
                ...
                feedback = input(Fore.YELLOW + "Please provide feedback on why you rejected the solution: ")
    ...
    def create_components(self, solution_description, solution_directory, interaction_count):
        ...
        """
            ...
            while True:
                ...
                if content:
                    # Ask the human operator for approval
                    approval = input(Fore.CYAN + "Do you approve the component implementation? (yes/no): ")
                    ...
                    if approval.lower() == "yes":
                        ...
                        feedback = input(Fore.YELLOW + "Please provide feedback on why you rejected the component implementation: ")
                    ...
                    print(Fore.RED + "Failed to parse the component implementation from the AI response.")
